...
class App:
    ...
    # 生成所有需要的图标
    def init_icons(self):
        self.master.filenew_icon = PhotoImage(file='fileopen.png')
        self.master.fileopen_icon = PhotoImage(file='fileopen.png')
        self.master.save_icon = PhotoImage(file='fileopen.png')
        self.master.saveas_icon = PhotoImage(file='fileopen.png')
        self.master.signout_icon = PhotoImage(file='fileopen.png')
    # 生成工具条
